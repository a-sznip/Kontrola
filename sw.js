...
const STATIC_CACHE_NAME = 'kontrole-static-v27'; // Aktualizacja wymuszająca pobranie 6 nowych modułów
...
self.addEventListener('install', event => {
  ...
  event.waitUntil(
    caches.open(STATIC_CACHE_NAME).then(cache => {
      console.log('[SW] Zapisywanie zmodernizowanych modułów aplikacji ES6 w pamięci podręcznej.');
