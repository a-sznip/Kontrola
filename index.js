...
// Wersja v2.2 - z naprawionym routingiem pod GitHub Pages
...
if(!userName || !authToken) {
    // NAPRAWA: Relatywna ścieżka do logowania
...
let offlineSatelliteLayer = L.tileLayer.localCache(satelliteUrl, { attribution: 'Tiles &copy; Esri', crossOrigin: true, layerId: 'satellite', maxZoom: 20, maxNativeZoom: 18 });
const parcelsUrl = 'https://integracja.gugik.gov.pl/cgi-bin/KrajowaIntegracjaEwidencjiGruntow';
let parcelsBoundariesLayer = L.tileLayer.wms.localCache(parcelsUrl, { layers: 'dzialki', format: 'image/png', transparent: true, attribution: 'GUGiK', layerId: 'parcels-boundaries' });
let parcelsNumbersLayer = L.tileLayer.wms.localCache(parcelsUrl, { layers: 'numery_dzialek', format: 'image/png', transparent: true, attribution: 'GUGiK', layerId: 'parcels-numbers', minZoom: 17 });
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if ('serviceWorker' in navigator) {
        window.addEventListener('load', () => {
            // NAPRAWA: Zmieniono /sw.js na ./sw.js
